...
<?php
    ...
    include("connect.php");
     ...
     from solider,rank,battlion,company,faction,`group` where rank.id=solider.id_rank && battlion.id=solider.id_battlion &&company.id=solider.id_company&& faction.id=solider.id_faction&& `group`.id=solider.id_group";
